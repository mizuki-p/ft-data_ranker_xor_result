...
TOKEN_NUMS = 3000000
RATIO = 1.0
EN_DATA_DIR =  r"<Working_Directory>/processed_dataset_en.jsonl"
# ZH_DATA_DIR = "refined_data/process_data_out/zh/dataset_zh.jsonl"
ZH_DATA_DIR = False
OUTPUT_FILES = r"<Working_Directory>/数据文件.jsonl"
